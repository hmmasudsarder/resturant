...
const Card = () => {
  return (
    <div>
      <div className="">
        <div className="w-72 h-full mx-20 my-28 bg-light rounded-xl pb-4">
          <div className="flex flex-col items-center justify-center gap-3 border-t-[20px] rounded-br-3xl">
          ...
          <div className="flex items-center justify-between gap-6 mx-8 h-4 bg-light">
